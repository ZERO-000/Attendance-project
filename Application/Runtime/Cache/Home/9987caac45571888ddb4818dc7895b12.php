				...
				success:function(data){
					...
					if (lesson == 1) {
						if (amHour1 <= 0 && amMinute1 <= 0) {
							...
							alert('签到失败' + "..." + '你以迟到' + amHour1 + "小时" + amMinute1 + "分钟")
							kaoqin = 2;
							var data = {
								'kaoqin':kaoqin,
								'student_id':student_id,
					...
					if (lesson == 3) {
						if (amHour2 <= 0 && amMinute2 <= 0) {
							...
							alert('签到失败' + "..." + '你以迟到000000' + amHour2 + "小时" + amMinute2 + "分钟")
							kaoqin = 2;
							var data = {
								'kaoqin':kaoqin,
								'student_id':student_id,
					...
					if (lesson == 5) {
						if (pmHour1 <= 0 && pmMinute1 <= 0) {
							...
							alert('签到失败' + "..." + '你以迟到' + pmHour1 + "小时" + pmMinute1 + "分钟")
							kaoqin = 2;
							var data = {
								'kaoqin':kaoqin,
								'student_id':student_id,
					...
					if (lesson == 7) {
						if (pmHour2 <= 0 && pmMinute2 <= 0) {
							...
							alert('签到失败' + "..." + '你以迟到' + pmHour2 + "小时" + pmMinute2 + "分钟")
							 kaoqin = 2;
							 var data = {
								 'kaoqin':kaoqin,
								 'student_id':student_id,
